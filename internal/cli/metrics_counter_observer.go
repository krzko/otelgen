...
var generateMetricsCounterObserverCommand = &cli.Command{
...
func generateMetricsCounterObserverAction(c *cli.Context) error {
	var err error
	...
	metrics.CounterObserver(ctx, meter, metricsCfg, logger)
