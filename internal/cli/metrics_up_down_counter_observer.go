...
var generateMetricsUpDownCounterObserverCommand = &cli.Command{
	Name:        "up-down-counter-observer",
...
func generateMetricsUpDownCounterObserverAction(c *cli.Context) error {
	var err error
	...
	metrics.UpDownCounterObserver(ctx, meter, metricsCfg, logger)
